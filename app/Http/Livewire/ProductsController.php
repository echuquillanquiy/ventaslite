...
class ProductsController extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.products.component', compact('products', 'categories'))->extends('layouts.theme.app')->section('content');
    }
    ...
    public function Store()
    {
        ...
        $messages = [
            ...
            'alerts.required' => 'Ingresa el valor mínimo en existecias',
