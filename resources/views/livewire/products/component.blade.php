                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td class="text-center">
                                        <span>
                                            <img src="{{ asset('storage/products/' . $product->imagen) }}" alt="imagen de ejemplo" height="70" width="80" class="rounded img-thumbnail">
                                        </span>
                                </td>
                                <td class="text-center">
                                    <a
                                        wire:click.prevent="Edit({{ $product->id }})"
                                        href="javascript:void(0)" class="btn btn-dark mtmobile" title="Edit">
